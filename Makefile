...
$(APP): $(MAIN) $(GRAPHICS_OBJ) $(PERSONAJE_OBJ) $(JUEGO_OBJ) $(SIMPLECONTROLLER_OBJ) $(SERIAL_OBJ) $(PODIO_OBJ)
	$(CC) -o $(APP) $(MAIN) $(WIN_FLAGS) $(GRAPHICS_OBJ) $(WINMM_LIB) $(PERSONAJE_OBJ) $(JUEGO_OBJ) $(SIMPLECONTROLLER_OBJ) $(SERIAL_OBJ) $(PODIO_OBJ)
