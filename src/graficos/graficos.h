...
extern const struct Ventana
{
	...
	/**
	 * @brief Muestra un dialogo en pantalla con parametros, mensaje y titulo
	 * @param msj Mensaje que se mostrara en en el dialogo.
	 * @param param Parametro que se mostrara en el dialogo.
	 * @param titulo Titulo del dialogo
	 */
	void (*muestraMensajeParametroInt)(const char *msj, const int param, const char *titulo);

	/**
	 * @brief Muestra un texto en las coordenadas x, y con parametros y tamanio fuente y tipo de fuente
	 * @param x coordenada en x
	 * @param y coordenada en y
	 * @param texto texto a mostrar
	 * @param tamanioFuente tamanio de la fuente
	 * @param fuente tipo de fuente
	 * @param param param a mostrar en el texto
	 */
